...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || "DARK-SILENCE-MD~KNQA1DaI#TsQUN7qctSYnT-EAfDlcS3Ku8u_U-H11lFPQ4Wb7frI",
    ...
    STATUS_REPLY: process.env.STATUS_REPLY || "`➺үσυя sтαтυs sεεη נυsт ησω вү Hunter_Zombie`",
